...
const translations = {
  en: {
    ...
    rewritingEmail: "Rewriting email to avoid spam...",
    rewritingEmailShort: "Rewriting...",
    rewriteFailedFallback: "AI rewrite unavailable. Sending the template email.",
    customize: "Customize",
  ...
  fa: {
    ...
    rewritingEmail: "در حال بازنویسی ایمیل برای جلوگیری از اسپم...",
    rewritingEmailShort: "در حال بازنویسی...",
    rewriteFailedFallback: "بازنویسی هوش مصنوعی در دسترس نیست. ارسال قالب اصلی.",
