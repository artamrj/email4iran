      ...
      <Tooltip delayDuration={300}>
        <TooltipTrigger asChild>
          <Button
            ...
            variant="ghost"
            className="rounded-full px-4 py-2 text-foreground hover:bg-secondary transition-colors duration-300 ease-in-out flex items-center gap-2" // Removed fixed positioning
