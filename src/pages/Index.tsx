...
const TopicCard: React.FC<{ topic: Topic }> = ({ topic }) => { // Use Topic type
  return (
    <Link to={`/${topic.slug}`} className="block h-full">
      <Card className="h-full flex flex-col justify-between rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out border-none bg-gradient-to-br from-iran-white to-gray-50 dark:from-gray-800 dark:to-gray-900">
