...
const ContactCard: React.FC<{ contact: Contact; personalization: Personalization }> = ({ contact, personalization }) => {
  ...
  return (
    <Card className="rounded-xl shadow-md border-2 border-transparent hover:border-iran-green dark:hover:border-iran-dark-green bg-gradient-to-br from-iran-white to-gray-50 dark:from-gray-800 dark:to-gray-900 p-4 flex flex-col justify-between h-full">
      ...
      <CardFooter className="p-0 pt-4 flex flex-col sm:flex-row gap-2">
        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button variant="outline" className="w-full sm:w-auto flex-grow rounded-lg border-primary text-primary hover:bg-primary/10 dark:border-primary/50 dark:text-primary-foreground dark:hover:bg-gray-700 text-sm py-2 px-3">
          ...
          <DialogContent className="sm:max-w-[425px] rounded-xl p-6">
            ...
            <DialogFooter className="flex flex-col sm:flex-row gap-2">
              ...
              <Button
                ...
                className="w-full sm:w-auto rounded-lg border-primary text-primary hover:bg-primary/10 dark:border-primary/50 dark:text-primary-foreground dark:hover:bg-gray-700 text-sm py-2 px-3"
                disabled={!subject || !body}
              >
...
const TopicDetail = () => {
  ...
  if (isLoadingTopic || isLoadingGroups || isLoadingContacts) {
    return (
      <div className="min-h-screen flex flex-col bg-gradient-to-br from-iran-white to-iran-green/5 dark:from-gray-950 dark:to-gray-900 p-4 sm:p-8">
        <div className="container mx-auto max-w-6xl py-8">
          <Button variant="ghost" onClick={() => navigate(-1)} className="mb-6 rounded-full text-muted-foreground hover:bg-secondary dark:hover:bg-gray-800">
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-iran-white to-iran-green/5 dark:from-gray-950 dark:to-gray-900 p-4 sm:p-8">
      <div className="container mx-auto max-w-6xl py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <Button variant="ghost" onClick={() => navigate(-1)} className="rounded-full text-muted-foreground hover:bg-secondary dark:hover:bg-gray-800">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <Card className="lg:col-span-2 rounded-xl shadow-lg border-2 border-transparent bg-gradient-to-br from-iran-white to-gray-50 dark:from-gray-800 dark:to-gray-900 p-6">
          ...
          <Card className="lg:col-span-1 rounded-xl shadow-lg border-2 border-transparent bg-gradient-to-br from-iran-white to-iran-red/5 dark:from-gray-800 dark:to-gray-900 p-6">
            <CardHeader className="p-0 pb-4">
            ...
            <CardContent className="p-0 grid gap-4">
              ...
              <div className="flex items-center justify-between space-x-2">
                ...
                <Switch
                  ...
                  className="data-[state=checked]:bg-primary data-[state=unchecked]:bg-secondary dark:data-[state=unchecked]:bg-gray-600"
                />
              </div>
              <Button
        ...
        <div className="mt-12">
          ...
          {groups?.map((group) => (
            <div key={group.id} className="mb-10">
              <h3 className="text-2xl font-semibold text-primary dark:text-primary-foreground mb-4">
                {group.name}
              </h3>
              ...
              <Separator className="my-8 bg-border dark:bg-gray-700 rounded-full" />
            </div>
          ))}
        </div>
      </div>
