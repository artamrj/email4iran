...
const ContactCard: React.FC<{ contact: Contact; personalization: Personalization }> = ({ contact, personalization }) => {
  ...
  return (
    <Card className="rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 flex flex-col justify-between h-full transition-all duration-300 hover:shadow-xl">
      ...
      <CardFooter className="p-0 pt-6 flex flex-col sm:flex-row gap-3">
        <Button
          ...
          className="w-full sm:w-auto flex-grow rounded-lg bg-purple-600 hover:bg-purple-700 text-white text-sm py-2 px-3 shadow-md transition-colors duration-200"
        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button variant="outline" className="w-full sm:w-auto flex-grow rounded-lg border-purple-600 text-purple-600 hover:bg-purple-50 dark:border-purple-400 dark:text-purple-400 dark:hover:bg-gray-700 text-sm py-2 px-3 shadow-md transition-colors duration-200">
              <ExternalLink className="mr-2 h-4 w-4" /> Customize
            </Button>
          </DialogTrigger>
          <DialogContent className="sm:max-w-[500px] rounded-xl p-8 bg-white dark:bg-gray-900 shadow-2xl">
            <DialogHeader className="mb-4">
              <DialogTitle className="text-3xl font-bold text-gray-900 dark:text-white">Customize Email</DialogTitle>
              <DialogDescription className="text-gray-600 dark:text-gray-400 mt-2">
                Feel free to edit the subject and body to make your message more personal.
              </DialogDescription>
            </DialogHeader>
            <div className="grid gap-5 py-4">
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  className="rounded-lg border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500"
                />
              </div>
              <div className="grid gap-2">
            ...
            <DialogFooter className="flex flex-col sm:flex-row gap-3 pt-4">
              <Button
                ...
                className="w-full sm:w-auto rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-sm py-2 px-3 shadow-md transition-colors duration-200"
                disabled={!subject || !body}
              >
              ...
              <Button
                ...
                className="w-full sm:w-auto rounded-lg border-blue-600 text-blue-600 hover:bg-blue-50 dark:border-blue-400 dark:text-blue-400 dark:hover:bg-gray-700 text-sm py-2 px-3 shadow-md transition-colors duration-200"
                disabled={!subject || !body}
              >
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-950 dark:to-gray-900 p-4 sm:p-8">
      <div className="container mx-auto max-w-6xl py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <Button variant="ghost" onClick={() => navigate(-1)} className="rounded-full text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 px-4 py-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Topic Context Block */}
          <Card className="lg:col-span-2 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-8">
            <CardHeader className="p-0 pb-6">
              <CardTitle className="text-3xl font-bold text-gray-900 dark:text-white">Context</CardTitle>
            </CardHeader>
          ...
          <Card className="lg:col-span-1 rounded-xl shadow-lg border border-blue-300 dark:border-blue-700 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/30 dark:to-purple-900/30 p-8">
            <CardHeader className="p-0 pb-6">
              <CardTitle className="text-3xl font-bold text-gray-900 dark:text-white">Personalize Your Message</CardTitle>
            </CardHeader>
            <CardContent className="p-0 grid gap-5">
              <div>
                <Label htmlFor="name" className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 block">Your Name</Label>
                <Input
                  id="name"
                  value={personalization.name}
                  onChange={(e) => setPersonalization({ ...personalization, name: e.target.value })}
                  placeholder="John Doe"
                  className="rounded-lg border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500"
                />
              </div>
              <div>
                <Label htmlFor="city" className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 block">Your City (Optional)</Label>
                <Input
                  id="city"
              ...
              <div>
                <Label htmlFor="country" className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 block">Your Country (Optional)</Label>
                <Input
                  id="country"
              ...
              <div className="flex items-center justify-between space-x-2 pt-2">
                <Label htmlFor="always-english" className="text-base font-medium text-gray-700 dark:text-gray-300">Always use English</Label>
                <Switch
                  id="always-english"
              ...
              <Button
                ...
                className="w-full rounded-lg bg-green-600 hover:bg-green-700 text-white text-base py-3 mt-4 shadow-md transition-colors duration-200"
              >
        ...
        {/* Categories & Contacts */}
        <div className="mt-16">
          <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-8 text-center">Key Contacts</h2>
          {categories?.map((category) => (
            <div key={category.id} className="mb-12 last:mb-0">
              <h3 className="text-3xl font-semibold text-purple-800 dark:text-purple-300 mb-3 text-center">
                {category.name}
              </h3>
              ...
              {categories.indexOf(category) < categories.length - 1 && (
                <Separator className="my-12 bg-gray-200 dark:bg-gray-700 rounded-full h-1" />
              )}
            </div>
          ))}
        </div>
      ...
      {/* Footer */}
      <footer className="w-full py-8 text-center text-gray-600 dark:text-gray-400 text-sm mt-auto">
