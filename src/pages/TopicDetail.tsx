    ...
    <Card className="rounded-xl shadow-md border-none bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-700 p-4 flex flex-col justify-between h-full">
      ...
      <CardFooter className="p-0 pt-4 flex flex-col sm:flex-row gap-2">
        <Button
          ...
          className="w-full sm:w-auto flex-grow rounded-lg bg-green-600 hover:bg-green-700 text-white text-sm py-2 px-3"
        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button variant="outline" className="w-full sm:w-auto flex-grow rounded-lg border-red-600 text-red-600 hover:bg-red-50 dark:border-red-400 dark:text-red-400 dark:hover:bg-gray-700 text-sm py-2 px-3">
              <ExternalLink className="mr-2 h-4 w-4" /> Customize
            </Button>
          </DialogTrigger>
          <DialogContent className="sm:max-w-[425px] rounded-xl p-6 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
            <DialogHeader>
            ...
            <DialogFooter className="flex flex-col sm:flex-row gap-2">
              <Button
                ...
                className="w-full sm:w-auto rounded-lg bg-green-600 hover:bg-green-700 text-white text-sm py-2 px-3"
                disabled={!subject || !body}
              >
              ...
              <Button
                ...
                className="w-full sm:w-auto rounded-lg border-red-600 text-red-600 hover:bg-red-50 dark:border-red-400 dark:text-red-400 dark:hover:bg-gray-700 text-sm py-2 px-3"
                disabled={!subject || !body}
              >
          ...
          <Card className="lg:col-span-2 rounded-xl shadow-lg border-none bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 p-6">
            <CardHeader className="p-0 pb-4">
              <div className="flex items-center gap-3 mb-2">
                ...
                <CardTitle className="text-4xl sm:text-5xl font-extrabold text-gray-900 dark:text-white leading-tight">
                  {topic.name}
                </CardTitle>
              </div>
            </CardHeader>
