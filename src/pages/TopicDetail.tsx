    ...
    <Card className="rounded-xl shadow-md border-none bg-card p-4 flex flex-col justify-between h-full">
      ...
      <CardFooter className="p-0 pt-4 flex flex-col sm:flex-row gap-2">
        <Button
          ...
          className="w-full sm:w-auto flex-grow rounded-lg bg-action-purple hover:bg-action-purple/90 text-action-purple-foreground text-sm py-2 px-3"
        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button variant="outline" className="w-full sm:w-auto flex-grow rounded-lg border-action-purple text-action-purple hover:bg-action-purple/10 dark:border-action-purple/70 dark:text-action-purple/70 dark:hover:bg-action-purple/20 text-sm py-2 px-3">
          ...
          <DialogContent className="sm:max-w-[425px] rounded-xl p-6">
            ...
            <DialogFooter className="flex flex-col sm:flex-row gap-2">
              <Button
                ...
                className="w-full sm:w-auto rounded-lg bg-action-blue hover:bg-action-blue/90 text-action-blue-foreground text-sm py-2 px-3"
                disabled={!subject || !body}
              >
              ...
              <Button
                ...
                className="w-full sm:w-auto rounded-lg border-action-blue text-action-blue hover:bg-action-blue/10 dark:border-action-blue/70 dark:text-action-blue/70 dark:hover:bg-action-blue/20 text-sm py-2 px-3"
                disabled={!subject || !body}
              >
    ...
    return (
      <div className="min-h-screen flex flex-col bg-background p-4 sm:p-8">
        <div className="container mx-auto max-w-6xl py-8">
          <Button variant="ghost" onClick={() => navigate(-1)} className="mb-6 rounded-full text-muted-foreground hover:bg-muted">
    ...
    <div className="min-h-screen flex flex-col bg-background p-4 sm:p-8">
      <div className="container mx-auto max-w-6xl py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <Button variant="ghost" onClick={() => navigate(-1)} className="rounded-full text-muted-foreground hover:bg-muted">
            ...
            <CardContent className="p-0 grid gap-4">
              ...
              <div className="flex items-center justify-between space-x-2">
                ...
                <Switch
                  ...
                  className="data-[state=checked]:bg-iran-green data-[state=unchecked]:bg-muted-foreground"
                />
              </div>
              <Button
                onClick={handleCopyAllEmails}
                className="w-full rounded-lg bg-iran-red hover:bg-iran-red/90 text-iran-red-foreground text-base py-3 mt-4"
              >
        ...
        <div className="mt-12">
          ...
          {groups?.map((group) => (
            <div key={group.id} className="mb-10">
              <h3 className="text-2xl font-semibold text-iran-green mb-4">
                {group.name}
              </h3>
