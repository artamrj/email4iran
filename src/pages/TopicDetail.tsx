...
const ContactCard: React.FC<{ contact: Contact; personalization: Personalization }> = ({ contact, personalization }) => {
  ...
  if (isLoadingTemplates) {
    return (
      <Card className="rounded-xl shadow-md border-2 border-border bg-card p-4 flex flex-col justify-between h-full">
          ...
          <DialogContent className="sm:max-w-[425px] rounded-xl p-6 bg-card text-card-foreground">
            ...
            <DialogFooter className="flex flex-col sm:flex-row gap-2">
              ...
              <Button
                ...
                className="w-full sm:w-auto rounded-lg border-secondary text-secondary-foreground hover:bg-secondary/10 dark:border-secondary dark:text-secondary-foreground dark:hover:bg-secondary/20 text-sm py-2 px-3"
                disabled={!subject || !body}
              >
    ...
    return (
      <div className="min-h-screen flex flex-col bg-background p-4 sm:p-8">
        <div className="container mx-auto max-w-6xl py-8">
          <Button variant="ghost" onClick={() => navigate(-1)} className="mb-6 rounded-full text-muted-foreground hover:bg-secondary">
    ...
    <div className="min-h-screen flex flex-col bg-background p-4 sm:p-8">
      <div className="container mx-auto max-w-6xl py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <Button variant="ghost" onClick={() => navigate(-1)} className="rounded-full text-muted-foreground hover:bg-secondary">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <Card className="lg:col-span-2 rounded-xl shadow-lg border-2 border-border bg-card p-6">
          ...
          <Card className="lg:col-span-1 rounded-xl shadow-lg border-2 border-border bg-card p-6">
            <CardHeader className="p-0 pb-4">
